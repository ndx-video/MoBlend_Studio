...
3. **Automated CI/CD Checks:**  
   ...
   * **Manifest Validation:** The CI runner checks the attached .manifest.json against the manifest-v1.schema.json to ensure no required fields are missing and that parameter types are valid.  
