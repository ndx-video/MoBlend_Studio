...
See [ROADMAP.md](../ROADMAP.md) for the milestone sequence (M0 scaffold → M1 engine → M2 broker → M3 desktop MVP → M4 registry → M5 OBS → M6 Sentinel) and the per-milestone "Done when" gates.
